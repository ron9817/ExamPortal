<div class="p-1">
    ...
    @if( isset( $data['exams_all_registered']["user_exam"]["2"] ) && count( $data['exams_all_registered']["user_exam"]["2"] ) > 0 )
		@foreach( $data['exams_all_registered']["user_exam"]["2"] as $exam_key => $exam )
		...
		<div class="data_element m-2 p-3 bg-secondary row">
			...
			<div class="col-sm-6 col-lg-3 col-12 d-flex justify-content-end">
				{{-- <div class="data_button_container">
					<a class="btn-primary-background bg-primary data_button d-inline-block" href="{{env('APP_URL')}}/score">
						<span class="px-3 d-inline-block"> View Score </span>
						<button type="button" class="btn btn-secondary interactive"> <i class="fa fa-arrow-right"></i> </button>
					</a>
				</div> --}}	
			</div>
